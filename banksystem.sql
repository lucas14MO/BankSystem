...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2025 at 08:41 PM
...
INSERT INTO `cheque` (`ID_CHEQUE`, `IDBANK_CHEQUE`, `IDEMITTER_ACCOUNT`, `IDRECEPTOR_ACCOUNT`, `ID_CHEQUESTATE`, `PAYMENT_CHEQUE`, `PUSHDATE_CHEQUE`, `ENDDATE_CHEQUE`, `ADDRESS_CHEQUE`, `ISDEFERRED_CHEQUE`) VALUES
(2, 1, 1, NULL, 1, 5000.00, '2025-06-03', '2025-07-03', 'Encarnacion Centro', 1);
...
CREATE TABLE `transaction` (
  ...
  `ID_BANK` int(11) NOT NULL,
  `IDEMITTER_ACCOUNT` int(11) NOT NULL,
  `IDRECEPTOR_ACCOUNT` int(11) NOT NULL,
...
ALTER TABLE `cheque`
  ...
  ADD KEY `cheque_bank` (`IDBANK_CHEQUE`);
...
ALTER TABLE `transaction`
  ...
  ADD KEY `FK_TRANSACT_ACOUNTTRA_ACCOUNT` (`IDRECEPTOR_ACCOUNT`),
  ADD KEY `FK_TRANSACT_CUENTATRA_ACCOUNT` (`IDEMITTER_ACCOUNT`),
...
ALTER TABLE `cheque`
  ...
  ADD CONSTRAINT `cheque_bank` FOREIGN KEY (`IDBANK_CHEQUE`) REFERENCES `bank` (`ID_BANK`);

--
-- Constraints for table `transaction`
--
ALTER TABLE `transaction`
  ADD CONSTRAINT `FK_TRANSACT_ACOUNTTRA_ACCOUNT` FOREIGN KEY (`IDRECEPTOR_ACCOUNT`) REFERENCES `account` (`ID_ACCOUNT`),
  ADD CONSTRAINT `FK_TRANSACT_CUENTATRA_ACCOUNT` FOREIGN KEY (`IDEMITTER_ACCOUNT`) REFERENCES `account` (`ID_ACCOUNT`),
